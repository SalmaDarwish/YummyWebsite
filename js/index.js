...
async function getData() {
  ...
  async function displayCategories(arr) {
    ...
    // $(".row-categories>div").click(function(){
    //     var categoryName=$(".categoryN").text()
...
//   meal= await fetch (`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${id}`);
//   meals = await meal.json();
//   console.log(meals);
...
//           recipes += `<li class="my-3 mx-1 p-1 alert-success rounded">${ingredients[j]}</li>`
